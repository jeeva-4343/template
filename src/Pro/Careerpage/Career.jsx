...
function Blog(){
    return (
        <Container fluid className="blog-contain">
            <Row >
                <Col >
                    <div className="blog-di">This is a Career page</div>
                    <p className="blogg-para">Digital marketing involves many of the same principles as 
                        ...
                        it's crucial to have a partner who understands the terrain and can lead you to the peak of online success.Digital marketing involves many of the same principles as 
                        traditional marketing and is often considered an additional way for
                         companies to approach consumers and understand their behavior. 
                         Companies often combine traditional and digital marketing techniques in their strategies.
                          But digital marketing also comes with its own set of challenges. Digital marketing 
